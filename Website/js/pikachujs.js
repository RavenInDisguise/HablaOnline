...
var tamWidh = [133,190,134,133,134,193,134,192,134];
var tamHeight = [133,133,133,134,192,134,189,134,189];
...
function testing() {
	...
	if(bien_ubicada == 9){
		facha_fin = new Date();
		var dif = facha_fin.getTime() - fecha_ini.getTime();
		...
		$.post( "function/send_pts.php", { puntos: puntos, type: typeofgame })
  			.done(function( data ) {
				  if(data == "1"){
					alert("¡Bien hecho! El juego ha terminado");
					win.play();
				  }else
